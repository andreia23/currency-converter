...
public class ConversionDTO {
	...
	public ConversionDTO(Long idTransaction, Long idUser, Currency sourceCurrency, BigDecimal sourceValue,
			Currency destinationCurrency, BigDecimal destinationValue, BigDecimal conversionRate) {
